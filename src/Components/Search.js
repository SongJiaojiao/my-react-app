        ...
        <section>
            ...
            {isAuthenticated ? (
                <div>
                    ...
                    <TextImageBlock imgLink={'/Search/ssd.png'} Title={'Quick Suggestion'} BgColor={'bg-surface-primary'} ImgBgColor={'var(--surface-lavender'} Spacing={'32px'} borderRadius={'16px'} Description={"As users type, they see live recommendations in the dropdown menu for quick access. To help them understand the relevancy of the results, I designed a quick preview feature that provides a visual snapshot of the result when they hover over it."} />
                    <TextImageBlock imgLink={'/Search/srp.png'} Title={'Answer the fundamental questions immediately'} BgColor={'bg-surface-primary'} ImgBgColor={'var(--surface-lavender'} Spacing={'32px'} borderRadius={'16px'} Description={"Once we identify users' search intents, we present the most crucial data and insights immediately in the quick facts panel, avoiding extensive drilling down. "} />
                    <TextImageBlock imgLink={'/Search/mobile.png'} Title={'Browse with speed and ease'} BgColor={'bg-surface-primary'} borderRadius={'16px'} ImgBgColor={'var(--surface-lavender'} Spacing={'32px'} Description={"On mobile, the content follows a linear pattern to adapt to the natuaral behavior. "} />
