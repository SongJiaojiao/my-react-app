        ...
        <section>
            ...
            {isAuthenticated ? (
                <div>
                    ...
                    <TextImageBlock imgLink={'/Trade/alerts.png'} Title={'Stay ahead with trade alerts'} BgColor={'bg-surface-primary'} ImgBgColor={'var(--surface-wasabi'} Spacing={'32px'} borderRadius={'16px'} Description={"Our users need to be highly attentive and take proactive steps to stay ahead of the market. Trade alerts highlight the most crucial economics so they won't miss any opportunities."} />
