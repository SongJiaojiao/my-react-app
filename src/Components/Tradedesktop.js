        ...
        <section>
            ...
            {isAuthenticated ? (
                <div>
                    ...
                    <TextImageBlock imgLink={'/Trade/EqDeriv.png'} Title={'Monitor trades with a single, unified view'} ImgBgColor={'var(--surface-wasabi'} borderRadius={'16px'} Spacing={'32px'} BgColor={'bg-surface-primary'} Description={"The new concept brings together information from various sources into one cohesive dashboard, allowing users to easily monitor and analyze trades without juggling between apps."} />
                    <TextImageBlock imgLink={'/Trade/TradeAlerts.png'} Title={'Stay ahead with trade alerts'} BgColor={'bg-surface-primary'} ImgBgColor={'var(--surface-wasabi'} Spacing={'32px'} borderRadius={'16px'} Description={"Our users need to be highly attentive and take proactive steps to stay ahead of the market. Trade alerts highlight the most crucial economics so they won't miss any opportunities."} />
                    <TextVideoBlock videoLink={'/Trade/Analytics.mp4'} Title={'Access insights in a single click'}  ImgBgColor={'var(--surface-wasabi'} Spacing={'32px'} BgColor={'bg-surface-primary'} borderRadius={'16px'} Description={"We provide trade insights such live economics and price movements. This allows users to develop post-trade strategies with efficiency and context, saving them from piecing together information from various sources."} />
                    <TextVideoBlock videoLink={'/Trade/Interoperability.mp4'} Title={'Sync, link, and share information'} Spacing={'32px 0px 32px 32px'} ImgBgColor={'var(--surface-wasabi'} BgColor={'bg-surface-primary'} borderRadius={'16px'} Description={"Users can link different applications to share data between them. This enables them to create interactive workspaces to simultaneously update multiple views with only one command."} />
